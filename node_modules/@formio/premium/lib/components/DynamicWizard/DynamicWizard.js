...
var DynamicWizard = /** @class */ (function (_super) {
    ...
    DynamicWizard.prototype.attachComponents = function (element, components, container, isDynamicWizard) {
        ...
        else if (!Utils._.isNil(this.step) && !((_a = element.children[0]) === null || _a === void 0 ? void 0 : _a.getAttribute('data-noattach')) && components[this.step]) {
    ...
    DynamicWizard.prototype.addRow = function (firstPage) {
        ...
        var editRow;
        if (Utils._.isNil(this.changingRowIndex)) {
